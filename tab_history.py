#!/usr/bin/env python3
"""
tab_history.py - History tab for viewing past sessions in Derby GUI (PyQt6 version)
"""
...
class HistoryTab:
    ...
    def _build_ui(self):
        ...
        row1_layout.addWidget(project_label)
        ...
        # Filter row 2: Period, Limit and Refresh
        ...
        row2_layout.addWidget(period_label)
